...
export default function PayrollManageModal({ record, onSave, onClose }) {
  ...
  const totalDed = form.loan_deduction + form.unpaid_leave_amount;
  const netPay   = form.gross_salary + form.overtime_amount - form.advance_salary - totalDed;
      ...
      <div className={styles.modal} onClick={e => e.stopPropagation()}>
        ...
        <div className={styles.body}>
          <div className={styles.formula}>
            Net Pay = Gross Salary + Overtime − Advance − Loan Deduction − Leave Deduction
          </div>
          ...
          <div className={styles.grid}>
            ...
            <label className={styles.field}>
              <span className={styles.label}>Overtime Amount</span>
              <input className={styles.input} type="number" value={form.overtime_amount} onChange={set('overtime_amount')} min={0} />
            </label>
            <label className={styles.field}>
          ...
          <div className={styles.breakdown}>
            ...
            <div className={styles.bRow}><span>+ Overtime</span><span className={`${styles.mono} ${styles.pos}`}>{formatCurrency(form.overtime_amount)}</span></div>
